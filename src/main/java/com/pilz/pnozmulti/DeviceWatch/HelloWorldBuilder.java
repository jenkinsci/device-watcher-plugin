...
public class HelloWorldBuilder extends Builder implements SimpleBuildStep
{
   ...
   /**
    * Descriptor for {@link HelloWorldBuilder}. Used as a singleton. The class is marked as public
    * so that it can be accessed from views.
    *
    * <p>
    * See {@code src/main/resources/hudson/plugins/hello_world/HelloWorldBuilder/*.jelly} for the
   ...
   public static final class DescriptorImpl extends BuildStepDescriptor<Builder>
   {
       ...
       *         <p>
       *         Note that returning {@link FormValidation#error(String)} does not prevent the form
